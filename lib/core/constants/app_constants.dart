...
class AppConstants {
  static const String name = "Yaseen Malik";
  ...
  // Section Keys for Scrolling Navigation
  static final List<String> navItems = ["Home", "About", "Skills", "Projects", "Journey", "Contact"];
}
...
class AppColors {
  ...
  static const Color cardBg = Color(0xFF1E2638);
}